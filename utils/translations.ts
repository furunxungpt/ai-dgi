export const translations = {
  zh: {
    ...
    indices: {
      ...
      soe_index: '央国企专题',
      soe_desc: '央国企DCMM贯标进展和数据治理现状洞察',
      public_co_index: '上市公司专题',
      public_co_desc: '上市企业DCMM贯标进展和数据治理现状洞察',
      view_details: '查看详情',
      current_index: '当前指数',
      benchmark: '基准线',
      growth: '同比增长(%)',
  ...
  en: {
    ...
    indices: {
      ...
      soe_desc: 'Insights into DCMM implementation progress and data governance status in SOEs.',
      public_co_index: 'Public Company Special Topic',
      public_co_desc: 'Insights into DCMM implementation progress and data governance status in Listed Companies.',
